        ...
        <div className="header-container">
          ...
          <Modal isOpen={modal} toggle={toggle} className={className}>
            ...
            <ModalBody>
              ...
              <br></br> Klicka på plus-tecknet på produkten för att spara den in
              i din slutliga lista. Fortsätt tills du är nöjd!
              <br></br>
              <br></br>
              <b>Att söka efter en hel lista med produkter</b>
              <br></br>
              För dig som är lat: Du kan skapa en inköpslista genom att fylla i
              det du letar efter i searchbar:en och klicka på det ljusgröna
              plus-tecknet. Din podukt kommer att hamna i en separat lista under
              searchbar:en. <br></br>
              <br></br> När du är klar med din inköpslista klickar du på 'Hämta
              prisförslag', och så far du ett förslag från varje butik som
              hamnar direkt in i din slutliga produktlista.
              <br></br>
              <br></br>
              <b>Lycka till!</b>
            </ModalBody>
